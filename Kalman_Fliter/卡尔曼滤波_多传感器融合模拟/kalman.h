...
//===========================================================================================================//
//==  注意需要:  A_COLUMN==X_ROW   H_COLUMN==X_ROW
//==             可能需要改变中间变量的大小
//===========================================================================================================//
...
#define   A_VALUE     {1, -0.1, 0, 1}




//在某些情况下B矩阵可以不使用
#define   B_ROW       2           //  定义B矩阵的行数
#define   B_COLUMN    1           //  定义B矩阵的列数
#define   B_LENGTH    2           //  保存B矩阵的数组的大小(B_ROW*B_COLUMN)
                                  //  B矩阵的初始值
                                  //  B矩阵保持不变
//#define   B_VALUE     {0.01, 0}
#define   B_VALUE     {0.1, 0}




#define   H_ROW       1           //  定义H矩阵的行数
#define   H_COLUMN    2           //  定义H矩阵的列数
#define   H_LENGTH    2           //  保存H矩阵的数组的大小(H_ROW*H_COLUMN)
                                  //  H矩阵的初始值: H矩阵是观测转移矩阵, 例如可以进行单位转换,幅度改变等
                                  //  H矩阵保持不变
//#define   H_VALUE     {1, 0}
#define   H_VALUE     {1, 0}
...
#define   u_ROW       1           //  定义u矩阵(估计值和最优值)的行数
#define   u_COLUMN    1           //  定义u矩阵(估计值和最优值)的列数
#define   u_LENGTH    1           //  保存u矩阵(估计值和最优值)的数组的大小(u_ROW*u_COLUMN)
                                  //  u矩阵的初始值: u矩阵的初始值,不是初始化条件之一,任意赋值即可
                                  //  u矩阵会随着测量而改变
//#define   u_VALUE     {1}
#define   u_VALUE     {1}
...
#define   Z_ROW       1           //  定义Z矩阵行数
#define   Z_COLUMN    1           //  定义Z矩阵的列数
#define   Z_LENGTH    1           //  保存Z矩阵的数组的大小(Z_ROW*Z_COLUMN)
                                  //  Z矩阵的初始值,不是初始化条件之一,任意赋值即可
                                  //  Z矩阵会随着测量而改变
#define   Z_VALUE     {0}


extern float         Z[Z_LENGTH];                   //  测量值(每次测量的数据需要存入该数组)
